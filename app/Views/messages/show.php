        ...
        <div class="row">
                        ...
                        <?php else: ?>
                            <?php foreach ($conversations as $conversation): ?>
                                <a href="/messages/<?php echo htmlspecialchars($conversation['username']); ?>" 
                                   class="list-group-item list-group-item-action <?php echo $conversation['username'] === $user['username'] ? 'active' : ''; ?>">
                                    <div class="d-flex align-items-center">
            ...
            <div class="col-md-8">
                ...
                <div class="card h-100">
                    <div class="card-header bg-white">
                        <div class="d-flex align-items-center">
                            <a href="/profile/<?php echo htmlspecialchars($user['username']); ?>" class="text-decoration-none">
                                <img src="<?php echo htmlspecialchars($user['profile_image'] ?? '/assets/images/default-avatar.png'); ?>" 
                            ...
                            <div>
                                <h5 class="mb-0">
                                    <a href="/profile/<?php echo htmlspecialchars($user['username']); ?>" class="text-decoration-none text-dark">
                                        <?php echo htmlspecialchars($user['username']); ?>
                                    </a>
                                </h5>
                                <small class="text-muted">
                                    <?php echo !empty($user['location']) ? htmlspecialchars($user['location']) : 'Online'; ?>
                                </small>
                            </div>
                        </div>
                    </div>
                    <div class="card-body d-flex flex-column">
                        <!-- Messages -->
                        <div class="messages-container flex-grow-1 overflow-auto mb-3" id="messagesContainer">
                            ...
                            <?php else: ?>
                                <?php foreach ($messages as $message): ?>
                                    <div class="message <?php echo $message['sender_id'] === $_SESSION['user_id'] ? 'message-sent' : 'message-received'; ?> mb-3">
